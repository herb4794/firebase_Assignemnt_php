...
<div class="login-container container-fluid">
    <div class="login-row row justify-content-center">
        <form id="googleForm" action="../../server/verify.php" class="login-form col-8" method="post">
            <h2>Sign in to HVAR.mall</h2>

            <div class="input-field username">
                <i class="login-link-user"></i>
                <input id="login-username" name="login_email" type="email" class="input-login-username">
                <label for="login-username" class="label-login-username">HVAR.mall ID</label>
            </div>
             
            <div class="input-field password">
                <i class="login-link-password-lock"></i>
                <input id="login-password" name="login_pass" type="password" class="input-login-password">
            ...
            <div class="social-media">
              ...
              <a id="googleBtn" class="social-icon-google"><i class="link-google"></i></a>
...
<div class="login-container container-fluid">
    <div class="login-row row justify-content-center">
        <form action="../../server/verify.php" class="login-form col-8" method="post">
            <h2>登入至 HVAR.mall</h2>
            ...
            <input type="submit" name="login_btn" value="登入" class="login-btn" />
